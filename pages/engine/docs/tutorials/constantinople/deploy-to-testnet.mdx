...
From your `packages/client` directory, you'll run `pnpm build` to build the client. Then, you can deploy the `packages/client/dist` directory to a static hosting service like [Netlify](https://www.netlify.com/) or [Cloudflare Pages](https://pages.cloudflare.com/).
